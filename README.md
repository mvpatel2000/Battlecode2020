...
To save on bytecode (see "Bytecode Optimization" below), we tried to keep our code as simple and decentralized as possible. In other words, robots should think locally. Their purpose in life should be determined from the moment they are born, not based on variable environmental features or enemey formations. This decision was also necessitated by the limited vision of robots. Since robots could only see small sections of the map, global coordination was extremely difficult without massive communication, which was not possible with the 7 message limit per turn.

When coordination was absolutely necessary, we ran all communications through the HQ, which had more bytecode available. The HQ would take in communications from miners, landscapers, and drones, and broadcast communications regularly about our HQ location, the enemy's HQ location, along with "attack" or "defend" signals for robots. For example, in our Seeding Tournament submission, we had an offensive miner who sprinted towards the enemy as soon as the game began. If the miner determined we could win the game on the offensive, he sent a signal to the HQ. The HQ then signaled "HALT PRODUCTION" to all defensive buildings. Our defensive drone factories and design schools, listening for word from the HQ, heard the broadcast and immediately ceased all creation of landscapers and drones. For the next hundred rounds, we used our soup only for offense–we built offensive design schools and landscapers, and scrambled to bury the enemy in an all-out blitz. This great arsenal of democracy crushed the enemy, for they could not match our rapid armament production. Such wartime manufacturing required nearly 100% of our soup income and labor force, along with great sacrifice on the part of our robots at home. 
